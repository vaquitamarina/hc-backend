...
## models/catalogo/catalogoModels.js

| Vocabulario Técnico Anterior | Vocabulario de Negocio Actual        | Impacto en el Diseño                                                                                |
| ---------------------------- | ------------------------------------ | --------------------------------------------------------------------------------------------------- |
| `getCatalogo`                | `listarOpcionesCatalogoClinico`      | El nombre deja claro que se devuelven opciones clínicas válidas y no una consulta técnica genérica. |
| `getCatalogoNombrePorId`     | `obtenerNombreOpcionCatalogoClinico` | Expresa con precisión la recuperación de un nombre clínico por identificador.                       |
| `result`                     | `opcionesCatalogo`                   | La variable comunica el conjunto de registros del catálogo.                                         |
| `row`                        | `opcionCatalogo`                     | El nombre identifica cada opción recuperada del catálogo.                                           |
| `nombre`                     | `nombreCatalogo`                     | El parámetro se vuelve explícito sobre el dominio consultado.                                       |

## models/hc/anamnesis/antecedenteModel.js

| Vocabulario Técnico Anterior | Vocabulario de Negocio Actual         | Impacto en el Diseño                                                                      |
| ---------------------------- | ------------------------------------- | ----------------------------------------------------------------------------------------- |
| `AntecedentePersonal`        | `AntecedentesPersonalesNoPatologicos` | El modelo se alinea con la forma clínica correcta de nombrar antecedentes no patológicos. |
| `AntecedenteMedico`          | `AntecedentesPersonalesPatologicos`   | El nombre refleja el bloque patológico de la anamnesis.                                   |
| `AntecedenteFamiliar`        | `AntecedentesHeredoFamiliares`        | El concepto heredo familiar queda representado con mayor precisión clínica.               |
| `AntecedenteCumplimiento`    | `SeguimientoDelTratamiento`           | El nuevo nombre comunica que se registra la adherencia y seguimiento terapéutico.         |
| `create`                     | `registrar`                           | El verbo se expresa en lenguaje de negocio y no como operación genérica.                  |
| `getById`                    | `consultarPorId`                      | La consulta deja de ser técnica y describe su intención clínica.                          |
| `getByHistoria`              | `consultarPorHistoria`                | El método expresa que recupera información ligada a la historia clínica.                  |
| `update`                     | `actualizarPorHistoria`               | La edición se entiende como mantenimiento de un bloque clínico específico.                |
| `id_historia`                | `historiaClinicaId`                   | El identificador se traduce al vocabulario de dominio.                                    |
| `idAntecedente`              | `antecedenteId`                       | El nombre identifica el registro concreto del antecedente.                                |

## models/hc/anamnesis/enfermedadActualModel.js

| Vocabulario Técnico Anterior | Vocabulario de Negocio Actual | Impacto en el Diseño                                                  |
| ---------------------------- | ----------------------------- | --------------------------------------------------------------------- |
| `EnfermedadActual`           | `PadecimientoActual`          | El modelo habla en el lenguaje clínico usual de padecimiento actual.  |
| `create`                     | `registrar`                   | El alta se expresa como acto clínico y no como persistencia genérica. |
| `getByHistoria`              | `consultarPorHistoria`        | La lectura se entiende como parte de la historia clínica.             |
| `update`                     | `actualizarPorHistoria`       | La modificación queda ligada al contexto del paciente.                |
| `id_historia`                | `historiaClinicaId`           | El parámetro se alinea con el dominio de negocio.                     |

## models/hc/anamnesis/filiacionModel.js

| Vocabulario Técnico Anterior | Vocabulario de Negocio Actual | Impacto en el Diseño                                                         |
| ---------------------------- | ----------------------------- | ---------------------------------------------------------------------------- |
| `Filiacion`                  | `DatosPersonalesPaciente`     | El nombre explica claramente que se trata de la ficha personal del paciente. |
| `create`                     | `registrar`                   | El nombre pasa a reflejar el alta de datos personales.                       |
| `getById`                    | `consultarPorId`              | La consulta se vuelve explícita y legible.                                   |
| `getByHistoria`              | `consultarPorHistoria`        | El método deja claro que opera sobre la historia clínica.                    |
| `update`                     | `actualizarPorHistoria`       | El mantenimiento se asocia al bloque de filiación.                           |
| `id_filiacion`               | `filiacionId`                 | El identificador queda nombrado por el dominio.                              |
| `id_historia`                | `historiaClinicaId`           | El vínculo con la historia queda semánticamente claro.                       |

## models/hc/anamnesis/motivoConsultaModel.js

| Vocabulario Técnico Anterior | Vocabulario de Negocio Actual | Impacto en el Diseño                                   |
| ---------------------------- | ----------------------------- | ------------------------------------------------------ |
| `MotivoConsulta`             | `MotivoAtencion`              | El nombre se alinea con el lenguaje del acto clínico.  |
| `create`                     | `registrar`                   | El alta del motivo se nombra como una acción clínica.  |
| `getById`                    | `consultarPorId`              | La consulta se expresa de forma natural en el dominio. |
| `getByHistoria`              | `consultarPorHistoria`        | La búsqueda se liga a la historia clínica.             |
| `update`                     | `actualizarPorHistoria`       | La edición conserva el contexto asistencial.           |
| `id_motivo`                  | `motivoId`                    | El identificador deja de parecer un detalle técnico.   |
| `id_historia`                | `historiaClinicaId`           | El parámetro se conecta con el expediente clínico.     |

## models/hc/examenFisico/examenGeneralModel.js

| Vocabulario Técnico Anterior | Vocabulario de Negocio Actual | Impacto en el Diseño                                   |
| ---------------------------- | ----------------------------- | ------------------------------------------------------ |
| `ExamenGeneral`              | `ExamenFisicoGeneral`         | El modelo se nombra con el concepto clínico completo.  |
| `create`                     | `registrar`                   | El alta del examen se describe desde el negocio.       |
| `getByHistoria`              | `consultarPorHistoria`        | La lectura se asocia al registro clínico del paciente. |
| `update`                     | `actualizarPorHistoria`       | La actualización queda dentro del flujo clínico.       |
| `id_examen`                  | `examenGeneralId`             | El identificador explica su propósito en el dominio.   |
| `id_historia`                | `historiaClinicaId`           | El vínculo con la historia clínica queda explícito.    |

## models/hc/examenFisico/examenRegionalModel.js

| Vocabulario Técnico Anterior | Vocabulario de Negocio Actual | Impacto en el Diseño                                            |
| ---------------------------- | ----------------------------- | --------------------------------------------------------------- |
| `ExamenRegional`             | `ExamenFisicoRegional`        | El nombre sitúa el bloque dentro del examen físico.             |
| `create`                     | `registrar`                   | El alta del examen regional se expresa con vocabulario clínico. |
| `getByHistoria`              | `consultarPorHistoria`        | La consulta se entiende como parte de la historia clínica.      |
| `update`                     | `actualizarPorHistoria`       | La actualización conserva el sentido asistencial.               |
| `id_regional`                | `examenRegionalId`            | El identificador se vuelve legible para el equipo de negocio.   |
| `id_historia`                | `historiaClinicaId`           | El parámetro queda anclado al expediente clínico.               |

## models/hc/hcModel.js

| Vocabulario Técnico Anterior  | Vocabulario de Negocio Actual             | Impacto en el Diseño                                                                       |
| ----------------------------- | ----------------------------------------- | ------------------------------------------------------------------------------------------ |
| `createReview`                | `registrarRevisionHistoriaClinica`        | La revisión deja de verse como un registro técnico y pasa a ser una acción clínica formal. |
| `getFiliationByIdHistory`     | `consultarFiliacionPorHistoriaClinica`    | El método expresa el bloque clínico recuperado.                                            |
| `registerHc`                  | `registrarHistoriaClinica`                | El alta de la historia se nombra con el lenguaje del negocio.                              |
| `getAllByStudentId`           | `consultarHistoriasClinicasPorEstudiante` | La consulta refleja la relación clínica-académica.                                         |
| `createDraft`                 | `crearBorradorHistoriaClinica`            | El borrador queda vinculado a la historia clínica.                                         |
| `assignPatient`               | `asignarPacienteAHistoriaClinica`         | El acto asistencial se expresa con claridad.                                               |
| `getPatientByHistory`         | `consultarPacientePorHistoriaClinica`     | La recuperación del paciente se nombra en contexto clínico.                                |
| `updateFiliation`             | `actualizarFiliacionHistoriaClinica`      | La modificación apunta al bloque de filiación.                                             |
| `getGeneralExam`              | `consultarExamenFisicoGeneral`            | El bloque general se nombra correctamente.                                                 |
| `updateGeneralExam`           | `actualizarExamenFisicoGeneral`           | La edición conserva la semántica clínica.                                                  |
| `getRegionalExam`             | `consultarExamenFisicoRegional`           | El examen regional se distingue con precisión.                                             |
| `updateRegionalExam`          | `actualizarExamenFisicoRegional`          | La actualización se mantiene dentro del bloque correcto.                                   |
| `getExamBoca`                 | `consultarExamenBucal`                    | El término bucal se ajusta al dominio odontológico.                                        |
| `updateExamBoca`              | `actualizarExamenBucal`                   | La modificación queda nombrada con vocabulario clínico.                                    |
| `getHigieneOral`              | `consultarHigieneOral`                    | La higiene oral se expresa de forma natural.                                               |
| `updateHigieneOral`           | `actualizarHigieneOral`                   | La edición conserva la intención de seguimiento clínico.                                   |
| `getDiagnosticoPresuntivo`    | `consultarDiagnosticoPresuntivo`          | El diagnóstico presuntivo se consulta en lenguaje de negocio.                              |
| `updateDiagnosticoPresuntivo` | `actualizarDiagnosticoPresuntivo`         | El mantenimiento del diagnóstico sigue el mismo lenguaje.                                  |
| `getDerivacion`               | `consultarDerivacion`                     | La derivación se entiende como parte del flujo clínico.                                    |
| `updateDerivacion`            | `actualizarDerivacion`                    | La edición se mantiene en el contexto asistencial.                                         |
| `getDiagnosticoClinicas`      | `consultarDiagnosticoClinico`             | El nombre corrige el plural y aclara el alcance clínico.                                   |
| `updateDiagnosticoClinicas`   | `actualizarDiagnosticoClinico`            | La actualización queda asociada a una sola sección clínica.                                |
| `getEvolucion`                | `consultarEvolucion`                      | La evolución se nombra como seguimiento del caso.                                          |
| `addEvolucion`                | `registrarEvolucion`                      | El alta de evolución se expresa como acto clínico.                                         |
| `idHistory`                   | `historiaClinicaId`                       | El identificador se alinea con el dominio.                                                 |
| `idStudent`                   | `estudianteId`                            | El nombre queda claramente ligado al estudiante.                                           |
| `idTeacher`                   | `docenteId`                               | El rol académico se expresa sin ambigüedad.                                                |
| `idPatient`                   | `pacienteId`                              | El identificador queda ligado al paciente.                                                 |

## models/hc/hcModels/listaHcAdultos.js

| Vocabulario Técnico Anterior | Vocabulario de Negocio Actual                | Impacto en el Diseño                                                   |
| ---------------------------- | -------------------------------------------- | ---------------------------------------------------------------------- |
| `getAdultHistoriasByStudent` | `listarHistoriasClinicasAdultasDeEstudiante` | El nombre se vuelve más explícito sobre la colección clínica devuelta. |
| `idEstudiante`               | `estudianteId`                               | El parámetro usa vocabulario uniforme en español.                      |
| `rows`                       | `historiasClinicasAdultas`                   | La variable deja claro el contenido consultado.                        |

## models/patient/patientModel.js

| Vocabulario Técnico Anterior | Vocabulario de Negocio Actual | Impacto en el Diseño                                         |
| ---------------------------- | ----------------------------- | ------------------------------------------------------------ |
| `createPatient`              | `registrarPaciente`           | El alta del paciente se nombra con lenguaje clínico directo. |
| `updatePatient`              | `actualizarPaciente`          | La modificación se expresa desde el negocio.                 |
| `nombre`                     | `nombrePaciente`              | El dato queda ligado al sujeto clínico.                      |
| `apellido`                   | `apellidoPaciente`            | El nombre evita ambigüedad.                                  |
| `dni`                        | `documentoIdentidad`          | El identificador se vuelve más comprensible para negocio.    |
| `fechaNacimiento`            | `fechaNacimiento`             | Se conserva porque ya es una expresión clara del dominio.    |
| `sexo`                       | `sexo`                        | Se conserva porque ya es un término clínico directo.         |
| `telefono`                   | `telefono`                    | Se conserva por legibilidad funcional.                       |
| `email`                      | `correoElectronico`           | El dato se expresa con vocabulario más claro.                |
| `id`                         | `pacienteId`                  | El identificador del registro queda explícito.               |

## models/student/studentModel.js

| Vocabulario Técnico Anterior  | Vocabulario de Negocio Actual            | Impacto en el Diseño                                         |
| ----------------------------- | ---------------------------------------- | ------------------------------------------------------------ |
| `getAdultPatientsByStudentId` | `consultarPacientesAdultosPorEstudiante` | El método comunica claramente la consulta clínica-académica. |
| `studentId`                   | `estudianteId`                           | El parámetro usa el vocabulario del dominio.                 |
| `result`                      | `pacientesAdultos`                       | La variable refleja el conjunto clínico recuperado.          |

## models/user/userModel.js

| Vocabulario Técnico Anterior | Vocabulario de Negocio Actual | Impacto en el Diseño                                           |
| ---------------------------- | ----------------------------- | -------------------------------------------------------------- |
| `getAll`                     | `listarUsuarios`              | La colección de usuarios se expresa con un verbo de negocio.   |
| `register`                   | `registrarUsuario`            | El alta se nombra como acción funcional.                       |
| `getUserById`                | `obtenerUsuarioPorId`         | La consulta puntual se vuelve explícita.                       |
| `login`                      | `autenticarUsuario`           | El término aclara que se trata del proceso de autenticación.   |
| `userCode`                   | `codigoUsuario`               | El identificador queda más legible.                            |
| `firstName`                  | `nombre`                      | Se abandona el inglés para alinearse con el dominio.           |
| `lastName`                   | `apellido`                    | El apellido se expresa con lenguaje ubicuo.                    |
| `dni`                        | `documentoIdentidad`          | El dato de identificación se describe mejor.                   |
| `email`                      | `correoElectronico`           | El correo se nombra de forma más clara.                        |
| `role`                       | `rol`                         | El vocabulario pasa a español y coincide con negocio.          |
| `password`                   | `contrasena`                  | La contraseña se nombra con grafía del dominio.                |
| `result`                     | `usuario`                     | La variable pasa a representar el usuario recuperado o creado. |
| `token`                      | `tokenAutenticacion`          | El resultado del login se entiende mejor.                      |
